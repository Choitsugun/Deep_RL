...
def handle_message(event, source):
    ...
    if user_dict[user_id].mode == "sleep":
        ...
        if user_message == "end" or user_message == "'end'":
            ...
            description = "[Quality] measures the coherence and grammatical accuracy of the responses.\n\
...
[Engagingness] measures the desire to engage the agents in a long conversation."
            line_bot_api.reply_message(
                    event.reply_token, 
...
0: Most responses are incoherent or contain grammatical errors, thereby preventing the dialogue from proceeding.\n\
1: Although certain responses are incoherent or contain grammatical errors, the dialogue can continue.\n\
...
1: Although not very coherent, certain responses convey an emotional tone or ask a question.\n\
2: Certain responses are both coherent and show care for or emotional attachment to the user."

            if eval_list[user_dict[user_id].eval_id] == "Engagingness":
                description = "0: The responses are lackluster or of poor quality, thereby making it difficult to sustain the dialogue.\n\
1: The responses are not particularly engaging, but they are adequate for continuing the dialogue.\n\
2: The responses are engaging and have the potential to develop into a dialogue."
